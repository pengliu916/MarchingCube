...
public:
	...
	MarchingCube(XMFLOAT4 volumeTexInfo, float MCCell_size = 1.0f / 128.0f, bool RTTexture = false,
	...
	HRESULT CreateResource(ID3D11Device* pd3dDevice, ID3D11ShaderResourceView*	pVolumeSRV)
	{
		...
		V_RETURN(DXUTCompileFromFile(L"MarchingCube.fx", nullptr, "VS", "vs_5_0", D3DCOMPILE_OPTIMIZATION_LEVEL3, 0, &pVSBlob));
		...
		V_RETURN(DXUTCompileFromFile(L"MarchingCube.fx", nullptr, "PS", "ps_5_0", D3DCOMPILE_OPTIMIZATION_LEVEL3, 0, &pPSBlob));
		...
		V_RETURN(DXUTCompileFromFile(L"MarchingCube.fx", nullptr, "GS", "gs_5_0", D3DCOMPILE_OPTIMIZATION_LEVEL3, 0, &pGSBlob));
